return {
	...
	lazy = false,
	opts = {
		dashboard = require("plugins-core.snacks.dashboard"),
		bigfile = { enabled = true },
		explorer = require("plugins-core.snacks.explorer"),
		image = { enabled = true },
		indent = { enabled = true },
		input = { enabled = true },
		picker = require("plugins-core.snacks.picker"),
		bufdelete = { enabled = true },
		notifier = require("plugins-core.snacks.notifier"),
		quickfile = { enabled = true },
		terminal = require("plugins-core.snacks.terminal"),
		scope = { enabled = true },
		scroll = require("plugins-core.snacks.scroll"),
