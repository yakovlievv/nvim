return {
	...
	lazy = false,
	opts = {
		dashboard = require("min.snacks.dashboard"),
		bigfile = { enabled = true },
		explorer = require("min.snacks.explorer"),
		image = { enabled = true },
		indent = { enabled = true },
		input = { enabled = true },
		picker = require("min.snacks.picker"),
		bufdelete = { enabled = true },
		notifier = require("min.snacks.notifier"),
		quickfile = { enabled = true },
		terminal = require("min.snacks.terminal"),
		scope = { enabled = true },
		scroll = require("min.snacks.scroll"),
