return {
	...
	lazy = false,
	opts = {
		dashboard = require("core-plugins.snacks.dashboard"),
		bigfile = { enabled = true },
		explorer = require("core-plugins.snacks.explorer"),
		image = { enabled = true },
		indent = { enabled = true },
		input = { enabled = true },
		picker = require("core-plugins.snacks.picker"),
		bufdelete = { enabled = true },
		notifier = require("core-plugins.snacks.notifier"),
		quickfile = { enabled = true },
		terminal = require("core-plugins.snacks.terminal"),
		scope = { enabled = true },
		scroll = require("core-plugins.snacks.scroll"),
